...
while ($row = $result->fetch_assoc()) {
    ...
    // -------------------------------------------------------------------------- Teleport Star City
    if (($input=='teleport star city' || $input=='star city') && $row['quest70']>=2) {
        if ($row['mp'] < 1) {
            echo $message="<i>You don't have enough MP to cast Teleport</i><br/>";
            include('update_feed.php'); // --- update feed
        } elseif ($row['room'] == 701) {
    ...
    // -------------------------------------------------------------------------- Teleport ulfberht
    if (($input=='teleport ulfberht' || $input=='ulfberht') && $row['KLulfberht']>=1) {
        if ($row['mp'] < $bosstelecost) {
            echo $message="<i>You don't have enough MP to cast Teleport</i><br/>";
            include('update_feed.php'); // --- update feed
        } elseif ($row['room'] == 'm15') {
            ...
            echo 'You teleport to Ulfberht!<br/>';
            $message="<i>You teleport to the Ulfberht! </i><br/>".$_SESSION['descm15'];
            include('update_feed.php'); // --- update feed
    ...
    // -------------------------------------------------------------------------- Teleport griffin
    if (($input=='teleport griffin' || $input=='griffin') && $row['KLgriffin']>=1) {
        if ($row['mp'] < $bosstelecost) {
            echo $message="<i>You don't have enough MP to cast Teleport</i><br/>";
            include('update_feed.php'); // --- update feed
        } elseif ($row['room'] == 'm25') {
            ...
            echo 'You teleport to the Griffin!<br/>';
            $message="<i>You teleport to the Griffin! </i><br/>".$_SESSION['descm25'];
            include('update_feed.php'); // --- update feed
    ...
    // -------------------------------------------------------------------------- Teleport stone sphinx
    if (($input=='teleport stone sphinx' || $input=='stone sphinx') && $row['KLstonesphinx']>=1) {
        if ($row['mp'] < $bosstelecost) {
            echo $message="<i>You don't have enough MP to cast Teleport</i><br/>";
            include('update_feed.php'); // --- update feed
        } elseif ($row['room'] == '516d') {
            echo $message="<i>You're already there!</i><br/>";
            include('update_feed.php'); // --- update feed
        } else {
            echo 'You teleport to the Stone Sphinx!<br/>';
            $message="<i>You teleport to the Stone Sphinx! </i><br/>".$_SESSION['desc516d'];
            include('update_feed.php'); // --- update feed
    ...
    // -------------------------------------------------------------------------- Teleport dark prince
    if (($input=='teleport dark prince' || $input=='dark prince') && $row['KLdarkprince']>=1) {
        if ($row['mp'] < $bosstelecost) {
            echo $message="<i>You don't have enough MP to cast Teleport</i><br/>";
            include('update_feed.php'); // --- update feed
        } elseif ($row['room'] == '516h') {
            echo $message="<i>You're already there!</i><br/>";
            include('update_feed.php'); // --- update feed
        } else {
            echo 'You teleport to the Dark Prince!<br/>';
            $message="<i>You teleport to the Dark Prince! </i><br/>".$_SESSION['desc516h'];
            include('update_feed.php'); // --- update feed
