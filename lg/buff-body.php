...
if ($row['equipBody'] =="training armor pro") {
    echo ' <span>( <i class="gold">+5</i>, <i class="red">+1</i>, <i class="green">+1</i> )</span>';
...
if ($row['equipBody'] =="pajamas") {
    echo " <span>( <i class='cyan'>+2</i> all stats )</span>";
...
if ($row['equipBody'] =="green cloak") {
    echo " <span>( <i class='green'>+3</i>, <i class='gold'>+3</i> )</span>";
    $results = $link->query("UPDATE $user SET dexmod = dexmod + 3");
    $results = $link->query("UPDATE $user SET defmod = defmod + 3");
}
// ----------------------------------------------------------------- black robe buff
if ($row['equipBody'] =="black robe") {
    echo " <span>( <i class='red'>+3</i>, <i class='blue'>+3</i> )</span>";
...
if ($row['equipBody'] =="sasquatch cloak") {
    echo " <span>( <i class='red'>+8</i>, <i class='gold'>+8</i> )</span>";
...
if ($row['equipBody'] =="forest cloak") {
    echo " <span>( <i class='green'>+10</i>, <i class='blue'>+4</i> )</span>";
...
if ($row['equipBody'] =="champion armor") {
    echo " <span>( <i class='gold'>+45</i>, <i class='red'>+5</i>, <i class='blue'>+5</i> )</span>";
...
if ($row['equipBody'] =="perfect armor") {
    echo " <span>( <i class='cyan'>+13</i> all stats )</span>";
...
if ($row['equipBody'] =="demon cape") {
    echo " <span>( <i class='blue'>+20</i>, <i class='black'>-20 def</i> )</span>";
...
if ($row['equipBody'] =="gamma robe") {
    echo " <span>( <i class='blue'>+15</i>, <i class='gold'>+50</i> )</span>";
