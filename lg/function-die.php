...
<h3 class='dead'>HP < 0 = DEAD!</h3>
<p>Well it happens to the best of us.</p>
<p>When your health gets low make sure to heal yourself by drinking a potion, eating some food or casting a heal spell.</p>
<br/>
<p>Your health has been replenished and you have been teleported back to the Grassy Field. </p>
<p>Godspeed.</p>
</div>";//.$_SESSION['desc001'];
