...
while ($row = $result->fetch_assoc()) {
    ...
    if ($input=='grab tea' || $input=='get tea') {
        ...
        if ($check >= 5) {
            ...
            echo $message="<div class='menuAction'><i class='fa fa-arrow-circle-up green'></i>You pick up 5 cups o' tea from the table!</div>";
            include('update_feed.php'); // --- update feed
