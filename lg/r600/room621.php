...
// -------------------------------------------------------------------------- BATTLE VARIABLES
	...
	<p class='px25'>+ Snow Bow! <span class='px16'>( +45 str, +15 mag, +15 def )</span></p>
	</div>";
            include('update_feed.php'); // --- update feed
