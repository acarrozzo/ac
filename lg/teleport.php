...
if ($row['teleport5']>=1){
 	...
 	else {echo '<div class="mapCube darkergray"><span>Rocky Plains</span></div>';}

	
if ($row['teleport3']>=1){
     echo '<input class="mapCube redBG" type="submit" name="input1" value="red town" /> ';}
 	else {echo '<div class="mapCube darkergray"><span>Red Town</span></div>';}

	

if ($row['teleport7']>=1){
     echo '<input class=" darkblueBG" type="submit" name="input1" value="underwater" /> ';}
 	else {echo '<div class=" darkergray"><span>Underwater</span></div>';}

if ($row['KLthunderbarbarian']>=1 || $row['KLsmoothranger']>=1 || $row['KLcoralwizard']>=1 || $row['KLheavywalrus']>=1 ){
	     echo '<input class=" wide lightblueBG white" type="submit" name="input1" value="master water temple" /> ';}
 	else {echo '<div class=" darkergray"><span>Master Temple</span></div>';}
