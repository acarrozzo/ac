...
<div id="center">
	...
	<div class="collapser">
		...
		<div class="collapserContent">
			<section>
				...
				<h5>HTML:</h5>
				<p class="red">Two divs with the following classes:</p>
				...
				<h5>JS:</h5>
				<p class="red"> Make sure you have jquery on your page.</p>
				...
				<h5>CSS:</h5>
				<p class="red"> The content is hidden by default. the JS makes it visible. I am also using font awesome for the arrows.</p>
	...
	<div class="collapserContent">
		<section>
			...
			<h5>HTML:</h5>
			<p class="red"> the 'data-pop' attribute activates the magic</p>
			<pre>
...
&lt;/figure&gt;</code>
			...
			<h5>JS:</h5>
			<p class="red"> This function toggles the .full class when clicked. Make sure you have jquery on your page.</p>
			<pre>
<code>$('[data-pop]').on(&quot;click&quot;, function () {<br/>	$(this).toggleClass(&quot;full&quot;);<br/>});</code>
			...
			<h5>CSS:</h5>
			<p class="red"> This makes the figure and image full screen when .full is applied</p>
			<pre>
